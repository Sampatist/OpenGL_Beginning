...
void Shader::SetUniform1f(const std::string& name, float vx)
{
    glUniform1f(GetUniformLocation(name), vx);
}

void Shader::SetUniform3f(const std::string& name, float vx, float vy, float vz)
{
...
void Shader::SetUniform1i(const std::string& name, int vx)
{
    glUniform1i(GetUniformLocation(name), vx);
}
